...
function buildSponsorBlocks(sponsor, manifest, cfMapForSlug=null) {
  ...
  return {
    ...
    primaryCtaText: sponsor.primary_cta_text || sponsor.cta_text || 'Get Matched With a Provider',
    callbackCtaText: sponsor.callback_cta_text || 'Request a Provider Call Back',
    nextStepsEnabled: sponsor.next_steps_enabled !== false,
    selfServeEnabled: sponsor.self_serve_enabled !== false,
    captureDirectMatch: sponsor.capture_direct_match !== false,
    captureDecisionHub: sponsor.capture_decision_hub !== false,
    captureSelfServe: sponsor.capture_self_serve !== false,
    leadCaptureMode: sponsor.lead_capture_mode || 'owned_form',
    sponsorDestinationMode: sponsor.sponsor_destination_mode || 'owned_form_then_route',
    assets: {
